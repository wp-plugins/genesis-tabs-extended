...
/*
  ...
  Description: Genesis Tabs extends the Featured Post widget to create a simple tabbed area. With the extended version
  you can also select if the selected posts have to be exclusive on the page (also within other tabs, when post is in
  more than one category). You can also add categories that are excluded when doing a query on the tabbed category.
  Author: Johan van de Merwe (credits to: nathanrice, studiopress and Ron Rennick)
    ...
    function form($instance) {
        ...
        <div class="genesis-widget-column-right">
            ...
            <div class="genesis-widget-column-box">
                ...
                <p><span class="description">Choose up to 8 categories to pull posts from.<br/> Each category you choose will represent a single tab.</span></p>
                ...
                <p><span class="description">Don't include posts from these categories<br/><em>if post is in more than one category, it is not used when it is in one of the selected categories below.</em></span></p>
